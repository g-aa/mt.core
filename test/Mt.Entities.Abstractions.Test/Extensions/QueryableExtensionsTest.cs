...
public sealed class QueryableExtensionsTest
{
    ...
    /// <summary>
    /// Положительный тест для <see cref="QueryableExtensions.SearchManyOrDefault{TEntity}(IQueryable{TEntity}, IEnumerable{Guid})"/>.
    /// </summary>
    /// <param name="seq">Наименование последовательности.</param>
    ...
    public void SearchManyOrDefaultPositiveTest(string seq, object[] objects)
    {
        ...
        // act
        var result = GetQueryable(seq)!.SearchManyOrDefault(ids);
    ...
    /// <summary>
    /// Отрицательный тест для <see cref="QueryableExtensions.SearchManyOrDefault{TEntity}(IQueryable{TEntity}, IEnumerable{Guid})"/>.
    /// </summary>
    /// <param name="seq">Наименование последовательности.</param>
    /// <param name="objects">UUIDs.</param>
    /// <param name="expected">Ожидаемый результат.</param>
